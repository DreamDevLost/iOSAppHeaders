...
- (void)dealloc;
- (id)initWithProcessPoolContainer:(id)arg1 dataStoreContainer:(id)arg2 frame:(struct CGRect)arg3 analytics:(id)arg4 alertHandler:(id)arg5 hostsForCookieInjector:(id)arg6 isCookieJSDisabled:(_Bool)arg7 optimizeForBackgroundProcessing:(_Bool)arg8 enableAutomaticMediaPlayback:(_Bool)arg9;
