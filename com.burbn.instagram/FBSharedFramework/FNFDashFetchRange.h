...
- (id)initWithType:(unsigned char)arg1 url:(id)arg2 offset:(long long)arg3 length:(int)arg4 startTime:(CDStruct_1b6d18a9)arg5 duration:(CDStruct_1b6d18a9)arg6 httpRequestHeaders:(id)arg7 isPredictive:(_Bool)arg8 isLiveHead:(_Bool)arg9 startSequenceIndex:(int)arg10 endSequenceIndex:(int)arg11;
