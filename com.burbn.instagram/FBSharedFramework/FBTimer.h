...
- (void)dealloc;
- (id)initWithBlock:(CDUnknownBlockType)arg1 interval:(double)arg2 minimumAfterPause:(double)arg3 tolerance:(double)arg4 queue:(id)arg5 repeats:(_Bool)arg6 appStateRunModes:(unsigned long long)arg7 sourceFile:(const char *)arg8 sourceLine:(int)arg9;
