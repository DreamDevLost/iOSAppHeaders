...
@class FBMediaUploadJobProgressInformation, NSDictionary, NSString;

@protocol FBMediaUploadListener <NSObject>
- (void)uploadHasProgressed:(NSString *)arg1 withProgressInformation:(FBMediaUploadJobProgressInformation *)arg2;
