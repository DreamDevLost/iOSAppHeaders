...
- (struct __CVBuffer *)createNextRenderedPixelBufferForVideoWriter:(IGVideoWriter *)arg1 withAdaptor:(AVAssetWriterInputPixelBufferAdaptor *)arg2 getPresentationTime:(CDStruct_1b6d18a9 *)arg3;
@end
