...
- (id)response;
- (id)send:(id *)arg1 timeoutInterval:(double)arg2 background:(_Bool)arg3 sessionDelegate:(id)arg4;
- (id)sendInBackgroundWithTimeoutInterval:(double)arg1 sessionDelegate:(id)arg2;
