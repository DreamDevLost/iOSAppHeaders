...
@interface IGDeferredAnalytics : NSObject <IGAnalyticsEventLoggingProtocol>
{
    id <IGAnalyticsEventLoggingProtocol> _forwardingAnalytics;
    NSMutableArray *_pendingEvents;
    id <IGScheduler> _loggingScheduler;
}
...
- (void)logPendingEventsThenForwardEventsToAnalytics:(id)arg1;
- (id)initWithLoggingScheduler:(id)arg1;
