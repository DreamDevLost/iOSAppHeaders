...
#import "FBFacecastWithActionsHandler.h"
...
- (void)updateRtmpConfig:(CDStruct_169bc05e)arg1;
- (void)finallyFetchedBroadcastID:(NSString *)arg1 withWebRTCSessionConfig:(CDStruct_af497ddf)arg2 rtmpConfig:(CDStruct_169bc05e)arg3 rtmpMessageChannel:(id <FBVideoBroadcastOutOfBandMessageChannel>)arg4;
- (void)startOffline;
