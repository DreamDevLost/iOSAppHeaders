...
- (id)initWithStartTime:(double)arg1 timespent:(double)arg2 lastImpressionTime:(double)arg3 state:(long long)arg4 percentVisible:(double)arg5 percentViewportCoverage:(double)arg6 hasSeenTopLeftCorner:(_Bool)arg7 hasSeenBottomRightCorner:(_Bool)arg8 reason:(unsigned long long)arg9 viewport:(struct CGRect)arg10 viewFrame:(struct CGRect)arg11;
