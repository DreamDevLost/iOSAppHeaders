...
@class IGCounterBadge, IGFeedToggleMetrics, IGUserSession, NSMutableArray, UIButton, UIImageView;
...
@property(nonatomic, getter=isFavoritesBadged) _Bool favoritesBadged; // @synthesize favoritesBadged=_favoritesBadged;
@property(nonatomic) __weak id <IGFeedToggleViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (void)_updateUsertagCount;
