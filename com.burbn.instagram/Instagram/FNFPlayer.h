...
@interface FNFPlayer : NSObject <FNFSynchronousPlayerDelegate, FNFAVPlayer>
{
    ...
    _Bool _updateWithPlayerInternalStateCurrentTime;
    _Bool _updateWithPlayRateFromInternalState;
}

- (void).cxx_destruct;
- (void)setPlayerStateUpdateListener:(id)arg1;
- (void)synchronousPlayer:(id)arg1 stateUpdated:(unsigned long long)arg2 playerState:(struct FNFPlayerInternalState)arg3;
- (void)dealloc;
- (void)invalidate;
...
- (id)initWithDisplayEngine:(id)arg1 clock:(id)arg2 config:(CDStruct_5476a51c)arg3 asyncTimebase:(_Bool)arg4 enableOpus:(_Bool)arg5;
- (id)initWithDisplayEngine:(id)arg1 config:(CDStruct_5476a51c)arg2 asyncTimebase:(_Bool)arg3 enableOpus:(_Bool)arg4;
