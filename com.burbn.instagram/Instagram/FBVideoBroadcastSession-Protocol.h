...
- (void)finallyFetchedBroadcastID:(NSString *)arg1 withWebRTCSessionConfig:(CDStruct_968ff9e3)arg2 rtmpConfig:(CDStruct_9abd5f9f)arg3 rtmpMessageChannel:(id <FBVideoBroadcastOutOfBandMessageChannel>)arg4;
- (void)startOffline;
