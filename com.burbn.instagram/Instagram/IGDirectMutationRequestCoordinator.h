...
#import "IGDirectMutationRequestProcessorCallbackInteractionSafeguardDelegate.h"
#import "IGDirectMutationRequestStateStoreListener.h"

@class IGDirectMutationRequestCoordinationCache, IGDirectMutationRequestStateStore, NSObject<OS_dispatch_queue>, NSString;
...
- (id)initWithRequestProcessorOrchestrationCache:(id)arg1 requestStateStore:(id)arg2 autoRetryConfigProvider:(CDUnknownBlockType)arg3 timeProvider:(CDUnknownBlockType)arg4 queue:(id)arg5;
