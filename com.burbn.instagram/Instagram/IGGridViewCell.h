...
#import "IGGridViewSelectedCellProtocol.h"
...
@property(retain, nonatomic) IGGradientView *durationLabelGradientView; // @synthesize durationLabelGradientView=_durationLabelGradientView;
...
@property(nonatomic) _Bool loopBounceEnabled; // @synthesize loopBounceEnabled=_loopBounceEnabled;
