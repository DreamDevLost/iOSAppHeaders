...
@class IGDirectRecentStickerListenerAnnouncer, IGDirectRecentStickerMemoryDataStore, IGDiskArchiver, NSArray, NSString;

@interface IGDirectRecentStickerService : NSObject <IGUserSessionObject>
{
    IGDiskArchiver *_diskArchiver;
    _Bool _needsUnarchiving;
    IGDirectRecentStickerMemoryDataStore *_recentStickerMemoryDataStore;
    IGDirectRecentStickerListenerAnnouncer *_announcer;
}
