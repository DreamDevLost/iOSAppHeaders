...
@property(readonly, nonatomic) _Bool showAudioToggleButton; // @synthesize showAudioToggleButton=_showAudioToggleButton;
...
- (id)initWithCurrentItem:(id)arg1 storyViewerViewModel:(id)arg2 userSession:(id)arg3 hasStoryLinks:(_Bool)arg4 isCanvasAd:(_Bool)arg5 draftMessage:(id)arg6 showFavoritesOnlyButton:(_Bool)arg7 showTrayButton:(_Bool)arg8 showReshareButton:(_Bool)arg9 isAudioEnabled:(_Bool)arg10 isShareToFBEnabled:(_Bool)arg11 isDisplayingSensitivityView:(_Bool)arg12 entryPoint:(long long)arg13 module:(id)arg14 netegoCellState:(unsigned long long)arg15 showViewInsightsCTAButton:(_Bool)arg16;
