...
@class IGAudioSessionClient, IGCaptureFlowViewModel, IGClipCollectionController, IGCropView, IGEditorAssetLoadingView, IGEditorTabBar, IGFeedGalleryVideoFetchRequest, IGFilterCollectionController, IGFilterControlView, IGMediaMetadata, IGOverlayNuxController, IGRearrangeOverlayView, IGSegmentedProgressView, IGShareListManager, IGSoundStateListener, IGUserSession, IGVideoComposition, IGVideoInfo, IGVideoPlayButton, IGVideoPlaybackView, IGVideoScrubberView, IGVideoTrimViewController, NSMutableDictionary, NSString, UIBarButtonItem, UIButton, UICollectionView, UIImage, UIImageView, UILabel, UIView, UIView<IGEditorTabView>;
