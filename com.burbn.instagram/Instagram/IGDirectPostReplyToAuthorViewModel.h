...
@class IGDirectMessageCellViewModel, IGDirectPostShare, IGDirectReshareDiffIdentifier, IGDirectTextMessageBubbleViewModel, IGFeedItem, IGStyledString, NSString;
...
@property(readonly, nonatomic) double dottedLinePadding; // @synthesize dottedLinePadding=_dottedLinePadding;
