...
#import "IGGridViewControllerProtocol.h"
...
@class IGUserSession, NSArray, NSIndexPath, NSMutableOrderedSet, NSObject<OS_dispatch_queue>, NSString, PHAssetCollection, PHCachingImageManager, PHFetchResult, PHImageRequestOptions, UICollectionView, UIColor, UILongPressGestureRecognizer;
