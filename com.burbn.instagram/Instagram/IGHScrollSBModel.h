...
@interface IGHScrollSBModel : NSObject <IGListDiffable, IGNetegoItem, NSCoding>
{
    NSString *_pk;
    NSArray *_items;
    NSString *_title;
...
- (id)initWithPK:(id)arg1 title:(id)arg2 items:(id)arg3 upsellPosition:(unsigned long long)arg4 actionText:(id)arg5 uuID:(id)arg6 trackingToken:(id)arg7;
