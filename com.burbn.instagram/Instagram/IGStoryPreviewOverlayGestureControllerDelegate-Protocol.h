...
- (void)overlayGestureController:(IGStoryPreviewOverlayGestureController *)arg1 didDeleteView:(UIView *)arg2;
- (void)overlayGestureController:(IGStoryPreviewOverlayGestureController *)arg1 didForceTouchView:(UIView *)arg2;
- (void)overlayGestureController:(IGStoryPreviewOverlayGestureController *)arg1 didTapView:(UIView *)arg2 atPoint:(struct CGPoint)arg3;
