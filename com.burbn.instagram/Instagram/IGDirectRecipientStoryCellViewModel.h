...
- (id)oneTapViewModel;
- (id)subviewModel;
- (id)initWithUser:(id)arg1 layoutSpec:(id)arg2 isSelected:(_Bool)arg3 isEnabled:(_Bool)arg4 backgroundColor:(id)arg5 oneTapButtonViewModel:(id)arg6 canShareToFbWithOneTap:(_Bool)arg7 willShareToFbWithOneTap:(_Bool)arg8 module:(id)arg9;
- (id)initWithUser:(id)arg1 subviewModel:(id)arg2 isSelected:(_Bool)arg3 isEnabled:(_Bool)arg4 backgroundColor:(id)arg5 oneTapButtonViewModel:(id)arg6 canShareToFbWithOneTap:(_Bool)arg7 willShareToFbWithOneTap:(_Bool)arg8;
