...
#import "IGVideoPlaybackAudioControllerDelegate.h"

@class IGAudioNUXController, IGFNFVideoPlayer, IGUserSession, IGVideoCaptionController, IGVideoPlaybackAudioController, IGVideoPlaybackItem, IGVideoPlaybackListenerAnnouncer, IGVideoViewLogger, NSString;
...
{
    IGVideoPlaybackListenerAnnouncer *_announcer;
