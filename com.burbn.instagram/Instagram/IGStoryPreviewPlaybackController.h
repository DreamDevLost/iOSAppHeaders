...
@interface IGStoryPreviewPlaybackController : NSObject <IGVideoPlaybackViewDelegate, IGStoryPreviewPlaybackControlling>
{
...
+ (id)newWithPlaybackView:(id)arg1;
...
- (void)play;
- (void)stop;
- (id)initWithPlaybackView:(id)arg1;
