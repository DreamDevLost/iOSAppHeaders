...
- (void)viewDidLoad;
- (id)initWithMediaType:(long long)arg1 userSession:(id)arg2 activityDataSource:(id)arg3 showStatusImages:(_Bool)arg4 isGroupThread:(_Bool)arg5 analyticsModule:(id)arg6;
