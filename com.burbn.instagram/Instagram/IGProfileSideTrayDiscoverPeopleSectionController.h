...
@class IGSideTrayRowItemModel, IGUserSession, NSArray;

@interface IGProfileSideTrayDiscoverPeopleSectionController : IGListSectionController <IGSideTrayItemSectionController>
{
...
- (_Bool)_shouldShowContactImporter;
- (void)_fetchFriendsBadgeStatus;
