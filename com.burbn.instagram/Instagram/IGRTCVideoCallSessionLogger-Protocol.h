...
@class IGVideoCallJoinResult, IGVideoCallLogEndCallReason, NSArray, NSError, NSString;
...
- (void)logEndCall:(IGVideoCallLogEndCallReason *)arg1 mqttConnected:(_Bool)arg2 tsLogString:(NSString *)arg3;
...
- (void)logJoinResult:(IGVideoCallJoinResult *)arg1 mqttConnected:(_Bool)arg2;
@end
