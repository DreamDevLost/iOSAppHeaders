...
@interface IGVideoFeedItemConfiguration : NSObject <IGFeedItemConfigurationType>
{
    IGUserSession *_userSession;
    id <IGFeedTheme> _theme;
    IGDefaultFeedItemConfiguration *_defaultConfig;
    _Bool _followButtonEnabled;
...
- (id)initWithUserSession:(id)arg1 feedTheme:(id)arg2 followButtonEnabled:(_Bool)arg3 followControllerContextString:(id)arg4;
