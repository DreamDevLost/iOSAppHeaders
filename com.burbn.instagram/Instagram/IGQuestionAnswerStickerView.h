...
@class FBTimer, IGQuestionAnswerStickerModel, IGRemoteImageView, IGTapButton, IGTextView, NSString, UIColor, UILabel, UITapGestureRecognizer;

@interface IGQuestionAnswerStickerView : UIView <UITextViewDelegate, IGConstrainedSizeStickerViewType, IGTappableStickerViewType>
{
