...
@class CAGradientLayer, CAShapeLayer, IGStoryMusicAnimatedAudioIndicatorBars, UIImageView, UILabel, UIView;
...
@interface IGStoryStickerTrayMusicStickerCell : UICollectionViewCell
{
    ...
    IGStoryMusicAnimatedAudioIndicatorBars *_audioIndicatorBars;
    UILabel *_label;
