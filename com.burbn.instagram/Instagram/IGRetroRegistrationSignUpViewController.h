...
@class IGAuthenticator, IGContactPointPrefillDataFetcher, IGContactPointPrefillLocalDataStore, IGKeyboardObserver, IGNUXLayoutSpec, IGRetroRegistrationSignUpView, NSDictionary, NSString, UITapGestureRecognizer;
...
- (void)viewDidLoad;
- (id)initWithFacebookInfo:(id)arg1 networker:(id)arg2 contactPointPrefillDataFetcher:(id)arg3 layoutSpec:(id)arg4 phoneNumber:(id)arg5 authenticator:(id)arg6 type:(unsigned long long)arg7;
