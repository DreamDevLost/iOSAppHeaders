...
@class BKBloksViewHelper, IGDefaultFeedItemConfiguration, IGHScrollAYMFViewModel, IGListAdapter, IGListAdapterUpdaterLogger, IGMainFeedNetegoImpressionStrategy, IGSuggestedFindUsersViewDataSource, IGSuggestedUsersTrackingManager, IGUserSession, IGViewController, NSMutableArray, NSMutableSet, NSString;

@interface IGHScrollAYMFSectionController : IGListSectionController <IGListAdapterDataSource, IGListAdapterDelegate, IGFollowControllerLoggingProvider, IGHScrollAYMFCellSectionControllerDelegate, UICollectionViewDelegate, IGHScrollAYMFBannerCellDelegate, IGHScrollAYMFHeaderCellDelegate, IGFindUsersViewDataSourceDelegate, UIScrollViewDelegate, IGViewAppearListener, IGViewDisappearListener, IGListDisplayDelegate, IGHScrollCollectionViewCellDelegate, IGHSCrollNuxCellSectionControllerDelegate, IGFavoritesHomeViewControllerDelegate, BKBloksViewHelperDelegate, IGActionSheetDelegate>
{
...
- (id)analyticsExtras;
- (_Bool)_shouldUseHeaderCell;
- (void)_runNewBadgeAnimation;
- (void)_updateStoredXOffset;
- (void)_updateScrollPosition;
- (void)_exposeHScrollExperiments;
...
- (id)initWithUserSession:(id)arg1 sessionId:(id)arg2 analyticsModule:(id)arg3 cellType:(long long)arg4 netEgoItemType:(unsigned long long)arg5 netegoImpressionStrategy:(id)arg6;
