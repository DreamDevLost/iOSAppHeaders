...
#import "FBInstantExperienceCallbackHandling.h"

@class NSString;

@interface FBBusinessExtensionInitializeCallbackHandler : FBScriptMessageHandlerBase <FBInstantExperienceCallbackHandling>
{
