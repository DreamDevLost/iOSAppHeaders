...
#import "IGRetroRegistrationOneTapViewControllerDelegate.h"

@class IGNUXFlowContext, NSString, UIViewController;

@interface IGNUXOneTapStepController : NSObject <IGNUXStepControllerProtocol, IGRetroRegistrationOneTapViewControllerDelegate>
{
