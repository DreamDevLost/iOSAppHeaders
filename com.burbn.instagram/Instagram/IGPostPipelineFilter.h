...
@class IGFilterGroup, IGImageFilter, IGLocalLaplacianFilter, IGLuxBlendFilter, IGNormalFilter, IGSurface, IGTiltShiftFilter, UIColor, UIImage;

@interface IGPostPipelineFilter : IGFilter <NSCopying>
{
    _Bool _borderHidden;
