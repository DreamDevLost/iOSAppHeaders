...
@class IGFeedItem, IGFollowListLogger, IGNavSearchBarItemConfiguration, IGUserListNetworkDataSource, IGUserSession, NSString, UIView;
...
@property(readonly, nonatomic) IGNavSearchBarItemConfiguration *searchBarItemConfig; // @synthesize searchBarItemConfig=_searchBarItemConfig;
...
- (id)initWithUserSession:(id)arg1 networkDataSource:(id)arg2 feedItem:(id)arg3 followListLogger:(id)arg4 searchBar:(id)arg5 emptyStateView:(id)arg6 userListStoryDelegate:(id)arg7;
