...
#import "IGLiveBroadcastSetupViewDelegate.h"
...
- (void)viewDidLoad;
- (id)initWithUserSession:(id)arg1 captureManager:(id)arg2 loggingContext:(id)arg3 broadcastCaption:(id)arg4 isInternalMode:(_Bool)arg5;
