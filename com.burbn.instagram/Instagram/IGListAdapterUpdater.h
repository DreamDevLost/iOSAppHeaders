...
@class IGListBatchUpdateData, IGListBatchUpdates, NSArray, NSMutableArray, NSObject<OS_dispatch_queue>, NSString;
...
@property(retain, nonatomic) NSObject<OS_dispatch_queue> *backgroundUpdateQueue; // @synthesize backgroundUpdateQueue=_backgroundUpdateQueue;
