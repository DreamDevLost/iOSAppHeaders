...
@class IGDirectVisualMessageViewModeSelectorModel, IGMediaMetadata, NSString, NSURL, UIImage;

@interface IGDirectOutgoingVisualMedia : FBValueObject <NSCopying, NSCoding>
{
    _Bool _usingNewMediaUploadInfra;
...
@property(readonly, nonatomic) _Bool usingNewMediaUploadInfra; // @synthesize usingNewMediaUploadInfra=_usingNewMediaUploadInfra;
...
- (id)initWithDependentMediaUploadId:(id)arg1 analyticsWaterfallId:(id)arg2 mediaMetadata:(id)arg3 viewMode:(id)arg4 replyType:(long long)arg5 uploadImage:(id)arg6 initialUploadVideoURL:(id)arg7 usingNewMediaUploadInfra:(_Bool)arg8 storyPostType:(long long)arg9;
