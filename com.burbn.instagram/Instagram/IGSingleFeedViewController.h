...
#import "IGDirectPivotSUDataSourceDelegate.h"
...
#import "IGSingleFeedViewControllerType.h"
#import "IGTombstoneManagerDelegate.h"

@class IGActionableConfirmationToastController, IGAdsBottomCTAController, IGCTAPresenterContext, IGContextualFeedBottomNuxController, IGDirectPivotSUDataSource, IGDiscoverPeopleItemConfiguration, IGFeedItem, IGFeedNetworkSource, IGFeedPreviewingHandler, IGFeedStarterKit, IGProfileChainingLogger, IGProfilePictureHelper, IGSingleFeedTitleHelper, IGSingleFeedViewControllerConfiguration, IGTableLayoutSpec, IGTombstoneManager, IGUserSession, NSArray, NSString;

@interface IGSingleFeedViewController : IGViewController <IGContextualFeedBottomNuxControllerDelegate, IGDirectPivotSUDataSourceDelegate, IGFeedNetworkSourceDelegate, IGFeedPreviewingType, IGFeedScrollViewListener, IGFeedStatusViewDelegate, IGListAdapterCompletionListener, IGListAdapterDataSource, IGListAdapterDelegate, IGTombstoneManagerDelegate, IGAdsBottomCTAControllerDelegate, IGSingleFeedViewControllerType, IGFeedItemPreviewProviding>
{
    ...
    IGActionableConfirmationToastController *_shoppingProductAppealsToastController;
