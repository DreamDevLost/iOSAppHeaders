...
- (id)initWithFileCache:(shared_ptr_232d0224)arg1 fileManager:(id)arg2 cacheMaxSize:(unsigned long long)arg3 cacheBasePath:(id)arg4 keyMigrationType:(long long)arg5;
