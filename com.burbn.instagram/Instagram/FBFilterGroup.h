...
@class FBBGRAtoYUVConverterFilter, FBCCPixelBufferPoolCache, FBGLContext, FBImageFilter, NSHashTable, NSMutableArray;
...
@interface FBFilterGroup : FBFilter <NSCopying, NSFastEnumeration>
{
    ...
    // Error parsing type: {SharedMutexImpl<false, void, std::atomic, false, false>="state_"{atomic<unsigned int>="__a_"AI}}, name: _dataMutex
...
- (_Bool)_render:(id)arg1 to:(id *)arg2 time:(CDStruct_1b6d18a9)arg3 renderingMode:(unsigned long long)arg4;
- (_Bool)_renderUsingFilter:(id)arg1 source:(id)arg2 to:(id)arg3 time:(CDStruct_1b6d18a9)arg4 renderingMode:(unsigned long long)arg5;
...
- (_Bool)render:(id)arg1 to:(id)arg2 time:(CDStruct_1b6d18a9)arg3 options:(unsigned long long)arg4 renderingMode:(unsigned long long)arg5;
...
- (id)initWithContext:(id)arg1 initialFilters:(id)arg2 pixelBufferPoolCache:(id)arg3;
