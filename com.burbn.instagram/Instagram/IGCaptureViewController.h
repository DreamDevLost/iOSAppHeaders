...
@class IGCaptureView, IGDeviceAngleSampler, IGMediaMetadata, IGMediaTabBar, IGSampleBuffer, IGStabilizationSampler, IGTooltipView, IGUserSession, IGVideoInfo, IGVideoRecorder, NSOperationQueue, NSString, UIBarButtonItem;
...
@property(retain, nonatomic) id <IGCaptureManaging> captureManager; // @synthesize captureManager=_captureManager;
