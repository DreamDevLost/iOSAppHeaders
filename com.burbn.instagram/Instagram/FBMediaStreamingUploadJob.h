...
#import "FBMediaUploadJob.h"

@class FBMediaFileStreamListenerAnnouncerWrapper, FBMediaStreamingUploadJobByteSender, FBMediaStreamingUploadJobStatusFetcher, FBMediaStreamingUploadMetricsBuilder, FBMediaUploadContentSource, FBMediaUploadJobDetail, NSObject<OS_dispatch_queue>, NSString, NSURL;
...
- (void).cxx_destruct;
- (void)_announceProgress:(id)arg1;
