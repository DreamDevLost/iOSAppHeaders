...
@interface IGSlideshowFeedConfiguration : NSObject <IGFeedConfigurationType>
{
    id <IGFeedConfigurationType> _defaultConfig;
    _Bool _useNewImpressionKit;
    _Bool _tapNavigationEnabled;
    _Bool _conservativePanGestureRecognition;
    long long _pageIndicatorType;
    _Bool _videoStitchingEnabled;
    long long _carouselDisplayMode;
    _Bool _fullviewLoggingEnabled;
    _Bool _fullHeightTapTargets;
    struct UIEdgeInsets _fullHeightTappableContentPadding;
}
...
- (id)initWithModule:(id)arg1 supportSponsoredTracking:(_Bool)arg2 userSession:(id)arg3 defaultConfig:(id)arg4;
