...
@class IGDirectAnimatedMediaLogger, IGDirectAnimatedMediaViewModel<IGVideoURLProvider>, IGFNFVideoPlayer, IGVideoPlayerManager, NSString, UIView;
...
- (void)dealloc;
- (id)initWithVideoPlayerManager:(id)arg1 logger:(id)arg2;
