...
@class CALayer, IGBlurredImageView, IGGradientView, IGRemoteImageView, NSString, UIImageView, UILabel;

@interface IGDiscoverySuggestedTopicPivotCell : UICollectionViewCell <IGRemoteImageViewDelegate>
{
    UILabel *_actionLabel;
    UILabel *_topicLabel;
    UIImageView *_chevron;
    IGRemoteImageView *_topicImageView;
    IGGradientView *_topicImageGradientView;
    IGBlurredImageView *_backgroundBlurredImageView;
    IGGradientView *_backgroundBlurredGradientView;
    CALayer *_highlightOverlay;
}

+ (id)cellIdentifier;
- (void).cxx_destruct;
- (void)_setOverlayViewsHidden:(_Bool)arg1;
...
- (void)configureWithSuggestedTopicPivotModel:(id)arg1 module:(id)arg2;
