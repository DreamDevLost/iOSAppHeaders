...
@interface IGImageRequest : NSObject
{
    ...
    NSURL *_url;
    NSString *_module;
    unsigned long long _desiredPhotoImageFlag;
...
@property(readonly, nonatomic) id <IGImageRequestLoader> imageLoader; // @synthesize imageLoader=_imageLoader;
...
@property(readonly, nonatomic) unsigned long long desiredPhotoImageFlag; // @synthesize desiredPhotoImageFlag=_desiredPhotoImageFlag;
...
- (void)cancel;
- (void)begin;
- (id)initWithUrl:(id)arg1 module:(id)arg2 desiredPhotoImageFlag:(unsigned long long)arg3 imageFetchPriority:(long long)arg4 fetchBehavior:(unsigned long long)arg5 cacheBehavior:(unsigned long long)arg6 shouldDecodeImage:(_Bool)arg7 previewData:(id)arg8 previewSize:(struct CGSize)arg9 imageLoader:(id)arg10 imageProcessor:(id)arg11 imageCompletionBlock:(CDUnknownBlockType)arg12 progressiveImageCompletionBlock:(CDUnknownBlockType)arg13 imageProgressBlock:(CDUnknownBlockType)arg14 previewImageCompletionBlock:(CDUnknownBlockType)arg15;
