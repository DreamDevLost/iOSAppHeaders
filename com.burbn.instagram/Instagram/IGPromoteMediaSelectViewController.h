...
@class IGAdEmptyView, IGBoostPostLogger, IGFeedNetworkSource, IGPromoteFlowPathManager, IGUserSession, NSArray, NSString, UIActivityIndicatorView, UICollectionView, UIView;
...
@interface IGPromoteMediaSelectViewController : IGViewController <IGAdEmptyViewDelegate, IGFeedNetworkSourceDelegate, UICollectionViewDelegate, UICollectionViewDataSource>
{
    ...
    IGPromoteFlowPathManager *_promoteFlowPathMananger;
