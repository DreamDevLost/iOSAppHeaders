...
#import "IGLiveCommentPinningServiceDelegate.h"
#import "IGLiveCommentPostingServiceDelegate.h"
#import "IGLiveCommentServiceDelegate.h"
...
- (void)switchToPollingService;
- (void)switchToRealtimeService;
- (void)stop;
- (void)start;
