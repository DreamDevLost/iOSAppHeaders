...
@class IGAnnouncer, IGDirectCache, IGUserSession, NSMutableOrderedSet, NSString;

@interface IGDirectVisualMessageReplayService : NSObject <IGDirectCacheListener, IGUserSessionObject, IGDirectVisualMessageViewerEventResponder>
{
...
- (void)_cacheUpdatedThreads:(id)arg1;
