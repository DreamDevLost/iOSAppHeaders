...
@interface IGDirectTypingStatusSectionController : IGListSectionController <IGListDisplayDelegate>
{
    NSString *_module;
    IGDirectTypingIndicatorViewModel *_viewModel;
}

@property(readonly, nonatomic) IGDirectTypingIndicatorViewModel *viewModel; // @synthesize viewModel=_viewModel;
- (void).cxx_destruct;
