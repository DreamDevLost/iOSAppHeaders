...
@class IGFollowController, IGReel, IGStoryViewerCell, IGStoryViewerSource, IGUserSession, NSString;

@interface IGStoryViewerSectionController : IGListSectionController <IGStoryViewerCellDelegate, IGReelSeenStateStoreListener, IGListDisplayDelegate>
{
    NSString *_reelId;
    ...
    _Bool _followStatusPreviouslyUnsure;
...
- (void)_onFriendshipStatusReceived:(id)arg1;
- (void)_updateFollowControllerIfNeededForUser:(id)arg1;
- (id)displayDelegate;
- (void)didUpdateToObject:(id)arg1;
- (void)dealloc;
- (id)initWithUserSession:(id)arg1 storyItem:(id)arg2 reelId:(id)arg3 viewerDelegate:(id)arg4 viewerListType:(long long)arg5 supportStoryRing:(_Bool)arg6 module:(id)arg7;
