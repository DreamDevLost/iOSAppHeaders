...
@interface IGUserListLocalDataSource : NSObject <IGAutocompleteAlmostAbstractDataSource>
{
...
- (void)_handleCommentsUpdatedNotification:(id)arg1;
- (void)addCommentUsersForComments:(id)arg1;
- (void)_addCommentUsersForFeedItem:(id)arg1;
