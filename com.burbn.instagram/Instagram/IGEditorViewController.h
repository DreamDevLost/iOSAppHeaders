...
@class IGAdjustController, IGCameraGuideView, IGCaptureFlowViewModel, IGEditorAssetLoadingView, IGEditorTabBar, IGFeedGalleryImageFetchRequest, IGFilterCollectionController, IGFilterControlView, IGFilteredPhotoView, IGMediaMetadata, IGRearrangeOverlayView, IGShareListManager, IGTiltShiftGestureController, IGUserSession, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSString, UIBarButtonItem, UIButton, UICollectionView, UIImage, UIImpactFeedbackGenerator, UILongPressGestureRecognizer, UIView, UIView<IGEditorTabView>;
...
@interface IGEditorViewController : IGViewController <UIGestureRecognizerDelegate, IGEditorTabBarDelegate, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, IGFeedGalleryAssetFetchRequestDelegate, IGFilterCollectionControllerDelegate, IGFilterControlViewDelegate, IGAdjustControllerDelegate, IGShareViewControllerDelegate>
{
    ...
    _Bool _useFilterForCropPreview;
    _Bool _editorCropEnabled;
    _Bool _newGalleryEnabled;
...
- (id)initWithLibraryAsset:(id)arg1 previewImage:(id)arg2 captureFlowViewModel:(id)arg3 userSession:(id)arg4;
- (id)initWithMediaMetadata:(id)arg1 originalImage:(id)arg2 cropRect:(struct CGRect)arg3 photoOrigin:(long long)arg4 shareListManager:(id)arg5 captureFlowViewModel:(id)arg6 userSession:(id)arg7;
...
- (id)_initWithPhotoOrigin:(long long)arg1 mediaMetadata:(id)arg2 shareListManager:(id)arg3 captureFlowViewModel:(id)arg4 userSession:(id)arg5;
- (void)dealloc;
