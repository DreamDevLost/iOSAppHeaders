...
@class CLLocationManager, IG4BLogger, IGBottomButtonsView, IGBusinessConversionLocationSuggestionParser, IGFacebookPageInfo, IGSuggestionHScrollView, IGUserSession, NSArray, NSDictionary, NSString, UIView;
