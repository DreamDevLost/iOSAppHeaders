...
@class FBFilter, FBFilterContext, FBFilterGroup, FBGLContext, FBVideoProcessorConfig, NSArray, NSObject<OS_dispatch_queue>, NSString;
...
- (_Bool)_renderPixelBuffer:(struct __CVBuffer *)arg1 toSurface:(id)arg2 time:(CDStruct_1b6d18a9)arg3 renderingOptions:(unsigned long long)arg4 renderingMode:(unsigned long long)arg5;
