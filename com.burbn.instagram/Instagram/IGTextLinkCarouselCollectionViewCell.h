...
@class IGImageSpecifier, IGRemoteImageView, NSString, UIColor, UIFont, UIImage, UIImageView, UILabel;

@interface IGTextLinkCarouselCollectionViewCell : UICollectionViewCell <IGRemoteImageViewDelegate>
{
    UILabel *_textLabel;
