...
@interface FBMQTTGroupCreationMutationRequest : TBaseStruct <TBase, NSCoding>
{
    ...
    struct NSMutableArray *__thrift_participants;
    long long __thrift_fbGroupId;
    struct NSMutableArray *__thrift_coCreatorIds;
...
- (id)initWithSenderId:(long long)arg1 participants:(struct NSMutableArray *)arg2 fbGroupId:(long long)arg3 coCreatorIds:(struct NSMutableArray *)arg4 offlineThreadingId:(long long)arg5 name:(id)arg6 description:(id)arg7 approvalMode:(int)arg8 joinableMode:(int)arg9 discoverableMode:(int)arg10 videoRoomMode:(int)arg11 emoji:(id)arg12 backgroundColor:(id)arg13 themeColor:(id)arg14 outgoingBubbleColor:(id)arg15 incomingBubbleColor:(id)arg16 entryPoint:(id)arg17 shouldFetchThreadInfo:(_Bool)arg18 createGroupMutationParams:(id)arg19 useExistingGroup:(_Bool)arg20 attemptId:(long long)arg21 optInGroupsSync:(_Bool)arg22 extra:(struct NSMutableDictionary *)arg23;
- (id)init;
