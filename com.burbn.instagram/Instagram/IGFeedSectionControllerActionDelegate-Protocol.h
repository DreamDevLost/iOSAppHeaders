...
@class IGFeedItem, IGHashtagModel, IGListSectionController<IGFeedSectionControllerType>, IGUser, NSString, UIView;

@protocol IGFeedSectionControllerActionDelegate <NSObject>
- (void)feedSectionController:(IGListSectionController<IGFeedSectionControllerType> *)arg1 showRelatedPostsForFeedItem:(IGFeedItem *)arg2;
- (void)feedSectionControllerDidTapDismissButton:(IGListSectionController<IGFeedSectionControllerType> *)arg1;
- (void)feedSectionController:(IGListSectionController<IGFeedSectionControllerType> *)arg1 didLikeFeedItem:(IGFeedItem *)arg2 mediaView:(UIView *)arg3;
...
- (void)feedSectionControllerDidTapOverflowButton:(IGListSectionController<IGFeedSectionControllerType> *)arg1;
