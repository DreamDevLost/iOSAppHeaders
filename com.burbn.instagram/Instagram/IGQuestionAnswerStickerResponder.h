...
+ (id)questionAnswerStickerResponderFromDict:(id)arg1 backgroundFillColor:(id)arg2 originalQuestion:(id)arg3 originalQuestionPk:(id)arg4;
...
- (id)diffIdentifier;
- (id)initWithHasSharedResponse:(_Bool)arg1 pk:(id)arg2 responderProfilePictureURL:(id)arg3 responderUsername:(id)arg4 responderPk:(id)arg5 response:(id)arg6 originalQuestion:(id)arg7 originalQuestionPk:(id)arg8 backgroundFillColor:(id)arg9 musicResponse:(id)arg10;
