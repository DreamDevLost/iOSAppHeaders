...
@class IGBusinessAttributeDetailViewModel, IGBusinessAttributeSyncContactInfoViewModel, IGBusinessAttributeSyncInfo, IGUserSession;

@interface IGBusinessAttributeSyncContactInfoSectionController : IGListSectionController
{
    IGUserSession *_userSession;
    IGBusinessAttributeDetailViewModel *_detailViewModel;
