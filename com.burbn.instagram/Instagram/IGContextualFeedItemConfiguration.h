...
@class IGCommentDraftDataController, IGDefaultFeedItemConfiguration, IGMainFeedItemConfiguration, IGUserSession, NSString;
...
@interface IGContextualFeedItemConfiguration : NSObject <IGFeedItemConfigurationType>
{
    ...
    _Bool _twoLineCaptionEnabled;
    _Bool _disablePreviewComments;
    long long _entryPoint;
    NSString *_entityId;
    NSString *_productId;
}

@property(nonatomic) _Bool disablePreviewComments; // @synthesize disablePreviewComments=_disablePreviewComments;
@property(nonatomic) _Bool twoLineCaptionEnabled; // @synthesize twoLineCaptionEnabled=_twoLineCaptionEnabled;
