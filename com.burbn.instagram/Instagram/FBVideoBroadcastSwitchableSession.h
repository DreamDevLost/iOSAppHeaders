...
#import "FBVideoBroadcastSwitchableStateProvider.h"
...
- (void)startOffline;
- (id)initWithState:(long long)arg1 rtmpSessionFactory:(CDUnknownBlockType)arg2 webRTCConfig:(CDStruct_968ff9e3)arg3 dynamicConfigProvider:(id)arg4 webRTCSessionFactory:(id)arg5 skipFlushDuringSwap:(_Bool)arg6 logger:(id)arg7 sessionDelegateShim:(id)arg8;
