...
- (void)layoutSubviews;
- (id)initWithImage:(id)arg1 video:(id)arg2 scrollEnabled:(_Bool)arg3 overrideAudioExpand:(_Bool)arg4;
- (id)initWithImage:(id)arg1 video:(id)arg2 backgroundColor:(id)arg3 scrollEnabled:(_Bool)arg4 overrideAudioExpand:(_Bool)arg5;
