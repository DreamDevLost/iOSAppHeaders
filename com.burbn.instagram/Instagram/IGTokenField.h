...
@class IGDynamicCollectionView, IGTableLayoutSpec, IGTextField, NSMutableArray, NSMutableOrderedSet, NSSet, NSString, UILabel;
...
- (id)initWithTokenFieldType:(unsigned long long)arg1;
