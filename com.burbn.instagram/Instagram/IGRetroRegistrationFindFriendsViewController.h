...
#import "IGRegistrationFriendsListViewControllerDelegate.h"
#import "IGStandardizedNUXInterstitialViewDelegate.h"

@class IGNUXInterstitialView, IGNUXLayoutSpec, IGRegistrationFriendsListViewController, IGRegistrationNavigationBar, IGStandardizedNUXInterstitialView, IGStandardizedNUXLayoutSpec, IGUserSession, NSString;
...
- (id)initWithFindFriendsMode:(long long)arg1 userSession:(id)arg2 layoutSpec:(id)arg3 standardizedLayoutSpec:(id)arg4 isNUXRedesignEnabled:(_Bool)arg5 contactsPermissionEnabled:(_Bool)arg6 previousFollowCount:(long long)arg7;
