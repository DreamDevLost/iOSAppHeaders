...
@class IGGating, IGRemoteImageView, NSString, NSURL, UIButton, UILabel;
...
@property(retain, nonatomic) IGRemoteImageView *profileImage; // @synthesize profileImage=_profileImage;
