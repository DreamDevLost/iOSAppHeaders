...
@interface IGTVGuideSingleChannelDataSource : NSObject <IGTVGuideDataSource>
{
...
- (id)initWithChannelDataSource:(id)arg1;
- (id)initWithChannelResponse:(id)arg1 userSession:(id)arg2;
