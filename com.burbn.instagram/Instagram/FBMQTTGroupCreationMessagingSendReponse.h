...
- (id)initWithThreadFbId:(long long)arg1 id:(long long)arg2 uuid:(long long)arg3 tid:(long long)arg4 blockedParticiants:(struct NSMutableArray *)arg5 errorCode:(long long)arg6 extra:(struct NSMutableDictionary *)arg7;
- (id)init;
