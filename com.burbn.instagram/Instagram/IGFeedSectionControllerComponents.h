...
#import "IGFeedSectionControllerComponentsType.h"
#import "IGListAdapterUpdateListener.h"
#import "IGViewAppearListener.h"
#import "IGViewDisappearListener.h"

@class IGActionableConfirmationToastController, IGAdsManagerLogger, IGCollectionViewVisibility, IGFeedHeartAnimator, IGFeedItemLogger, IGFeedScrollViewAnnouncer, IGFeedSectionViewabilityTracker, IGFeedVideoCellManager, IGListAdapter, IGListAdapterScrollingContext, IGSaveFeedUfiConfiguration, IGUserSession, IGViewController, NSString;

@interface IGFeedSectionControllerComponents : NSObject <IGFeedScrollViewListener, IGListAdapterUpdateListener, IGViewAppearListener, IGViewDisappearListener, IGFeedSectionControllerComponentsType>
{
    _Bool _experimentalCarouselImpressionsEnabled;
    _Bool _viewVisible;
    _Bool _updateCellsOnFeedAppearanceQEEnabled;
    _Bool _updateCTAAndShelfCellsInAllSituationsEnabled;
...
- (void)_updatePageCellsForViewDisappearance;
...
- (_Bool)_tryShowAvatarStoryTooltip;
- (void)_tryShowFavoritesTooltip;
- (_Bool)_supportsFavoritesTooltip;
