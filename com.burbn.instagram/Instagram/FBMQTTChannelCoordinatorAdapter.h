...
#import "FBMQTTChannelCoordinating.h"
#import "FBMQTTNetworkStatusChangedListening.h"
#import "LigerReachabilityCallback.h"

@class FBMQTTChannelEndpointCapabilities, FBMQTTClientCapabilities, FBMQTTClientConfiguration, FBMQTTConfigurations, FBMQTTConnectionConfiguration, FBMQTTCredentials, FBMQTTExperiments, FBMQTTNetworkStatusMonitor, JSONDecoder, NSDictionary, NSMapTable, NSMutableArray, NSObject<OS_dispatch_queue>, NSString;
...
@interface FBMQTTChannelCoordinatorAdapter : NSObject <FBMQTTNetworkStatusChangedListening, LigerReachabilityCallback, FBMQTTChannelCoordinating>
{
    ...
    struct shared_ptr<facebook::mqttchannel::H2PubSubConnectionFactory> _h2PubSubConnectionFactory;
    ...
    _Bool _isH2PubSubEnabled;
}

- (id).cxx_construct;
- (void).cxx_destruct;
- (id)_generateBugReport;
- (vector_7984f87c)_removeListeners:(id)arg1;
