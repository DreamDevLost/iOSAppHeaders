...
@interface IGQuickCamInputCameraPhotoAsset : NSObject <IGQuickCamInputAsset, IGQuickCamImageType>
{
    _Bool _isLandscape;
...
- (void).cxx_destruct;
- (id)initWithImage:(id)arg1 devicePosition:(long long)arg2 flashMode:(long long)arg3 metadata:(struct NSDictionary *)arg4;
