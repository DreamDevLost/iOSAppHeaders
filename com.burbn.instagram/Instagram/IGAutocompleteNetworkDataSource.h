...
@class IGRequestToken, IGSearchCache, IGSearchCacheEntry, IGUserSession, NSTimer;
...
@property(retain, nonatomic) IGRequestToken *currentRequestToken; // @synthesize currentRequestToken=_currentRequestToken;
