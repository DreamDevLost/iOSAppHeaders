...
@class IGSettingsNotificationsModel, IGUserSession;

@interface IGSettingsNotificationsViewController : IGGroupedTableViewController <IGSettingsSearch>
{
...
- (void)_configureNotificationsCell:(id)arg1 forRow:(long long)arg2;
- (void)performActionForNotificationsRowType:(long long)arg1;
